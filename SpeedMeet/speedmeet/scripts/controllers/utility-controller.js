        ...
        function UtilityController(oApplication, presenceSettings) {
            ...
            */
            ...
            this.updateParticipantInfo = function (announcementValue, oListItem) {
                ...
                oDAMeetList.updateListItemByItemId(oListItem.ID, fieldsObject, true).
                    done(function () {
                        oDeferred.resolve();
                    });
            ...
            this.getPresence = function (accountName, data) {
                ...
                if (pictureUrl == null)
                    ...
                    pictureUrl = oApplication.getSPHostWebUrl() + "/_layouts/15/userphoto.aspx?size=M&accountname=" + account
                }

    ...
    function (DAUtility, DALayer, PoolContainer, DAMeetEventList) {
        function MeetEventController(oApplication) {
                                        ...
                                        .done(function (oListItem) {
                                            ...
                                            getParticipantsKeys(oApplication.getParticipants())
                                                .done(function (arrayUserKeys) {
                                                    ...
                                                    var newLocation = {};
                                                    newLocation["locationChanged"] = isNewLocation;
                                                    newLocation["userKeys"] = oListItem.Participants1Id.results;
                                                    changesRecorder.push(newLocation);

                                                    var newParticipants = {}
                                                    newParticipants["userKeys"] = newUsers;
                                                    changesRecorder.push(newParticipants);
            ...
            this.getEmailObjectsByUsers = function (emailType, olUsers, oListitem, newUsers) {
                ...
                if (newUsers != null) {
                    $(newUsers).each(function (index, userId) {
